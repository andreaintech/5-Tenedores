    ...
    return (
        <View>
            {userLogged ? (
                ...
                <View>
                    <Text
                        style={{ textAlign: "center", color: "#00a680", padding: 2}}
                        onPress={() => navigation.navigate("login")}
                    >
                        Para escribir una opinion debe iniciar sesion {" "}
        ...
        <View style={styles.viewReview}>
            ...
            <View style={styles.viewInfo}>
                ...
                <Rating
                    ...
                    readonly
                />
                <Text style={styles.reviewDate}>{createReview.getDate()}/{createReview.getMonth() + 1}/{createReview.getFullYear()} - {createReview.getHours() < 10 ? "0" : ""}{createReview.getHours()}:
